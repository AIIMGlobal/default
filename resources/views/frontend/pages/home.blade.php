...
@section('title', ''.($global_setting->title ?? "SEBPO - Project management software").' | ')
@section('content')
                    ...
                    <div class="col-lg-8 col-sm-10">
                        <div class="text-center mt-lg-5 pt-5">
                            ...
                            <div class="d-flex gap-2 justify-content-center mt-4">
                                <a href="#" class="btn btn-primary">Get Started <i class="ri-arrow-right-line align-middle ms-1"></i></a>
                        ...
                        <div class="card">
                            <div class="card-body text-center p-4">
                                <div class="avatar-xl mx-auto mb-4 position-relative">
                                    ...
                                    <a href="#" class="btn btn-success btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-2">
                            <a href="#" class="btn btn-primary">View All Members <i class="ri-arrow-right-line ms-1 align-bottom"></i></a>
                        </div>
                    </div>
                </div>
                <!-- end row -->
