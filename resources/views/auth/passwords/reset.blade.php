                                ...
                                <form action="{{ route('password.update') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="fxt-transformY-50 fxt-transition-delay-1">
                                            <input type="text" id="username" class="form-control" name="email" placeholder="Enter Email" value="{{ $email ?? old('email') }}" required="required">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="fxt-transformY-50 fxt-transition-delay-2">
                                            <input id="password_confirmation" type="password" class="form-control" name="password_confirmation" placeholder="Re-enter Confirm Password" required="required">
