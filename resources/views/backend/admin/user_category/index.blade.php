...
@section('title', ''.($global_setting->title ?? "").' | Employee Category')
@section('content')
            ...
            <div class="col-xxl-12">
                ...
                <div class="card card-height-100">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Employee Category</h4>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-xxl-2 col-sm-6">
                                    <div class="search-box">
                                        <input @if(isset($_GET['name']) and $_GET['name']!='') value="{{$_GET['name']}}" @endif type="text" class="form-control search" name="name" placeholder="Category Name">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{route('admin.user_category.update', $user_category->id)}}" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="row g-3">
                                                                    <div class="col-12">
                                                                        <div>
                                                                            <label for="নাম" class="form-label">Category Name<span style="color:red;">*</span></label>
                                                                    ...
                                                                    <div class="col-12">
                                                                        <div>
                                                                            <label for="নাম" class="form-label">Category Serial</label>
                                                                            <input type="text" class="form-control" name="sl" value="{{$user_category->sl}}" placeholder="Enter Category Serial">
                                                                        </div>
                                                                    </div><!--end col-->
...
<div class="modal fade" id="addNewHost" tabindex="-1" aria-labelledby="addNewHostLabel" aria-modal="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addNewHostLabel">Add New Category</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{route('admin.user_category.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div>
                                <label for="নাম" class="form-label">Category Serial</label>
                                <input type="text" class="form-control" name="sl" placeholder="Enter Category Serial">
                            </div>
                        </div><!--end col-->
