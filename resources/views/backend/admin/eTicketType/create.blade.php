...
@section('title', ''.($global_setting->title ?? "").' | Add E-Ticket Type')
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Add E-Ticket Type</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>

                                <li class="breadcrumb-item active">Add E-Ticket Type</li>
                            </ol>
                        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-height-100">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Add E-Ticket Type</h4>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.eTicketType.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" id="title" name="title" placeholder="Enter E-Ticket Type" value="{{ old('title') }}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12 mt-4">
                                        <div>
                                            ...
                                            <input type="number" min="1" class="form-control" id="sl" name="sl" placeholder="Enter Sort Order No." value="{{ old('sl') }}">
                                        </div>
                                    </div>
                                </div>
