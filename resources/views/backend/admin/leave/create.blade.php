...
@section('title', ''.($global_setting->title ?? "").' | New Leave Application')
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">New Leave Application</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>

                                <li class="breadcrumb-item active">New Leave Application</li>
                            </ol>
                        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-height-100">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">New Leave Application</h4>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($categorys as $category)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">{{ ($remain == $category->day_number) ? ($category->day_number ?? 0) : ($remain ?? 0) }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.leave.store') }}" method="POST" class="mt-4" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-6 col-sm-12">
                                        <div>
                                            ...
                                            <input type="number" min="0" class="form-control" id="day_count" name="day_count" placeholder="Enter Total Days" required>
                                        </div>
                                    </div>
