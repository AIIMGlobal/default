...
@section('title', ''.($global_setting->title ?? "").' | Current Year Leave Summary')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Current Year Leave Summary</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>

                                <li class="breadcrumb-item active">Current Year Leave Summary</li>
                            </ol>
                        </div>
                ...
                <div class="col-xxl-12">
                    ...
                    <div class="card card-height-100">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Current Year Leave Summary</h4>
                        </div>
                        <!-- end card header -->
                            ...
                            <form>
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-2 col-sm-4">
                                        <div>
                                            <a style="max-width: 150px;" href="{{ route('admin.leave.leaveSummary') }}" class="btn btn-danger w-100"> 
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            @foreach ($categorys as $category)
                                                <th class="text-center">Remaining {{ $category->name_en }}</th>
                                            @endforeach
                                        </tr>
                                    </thead>
                                            ...
                                            @foreach ($leaves as $leave)
                                                <tr>
                                                    ...
                                                    @php
                                                        ...
                                                        foreach ($categorys as $category) {
                                                            $totalTaken = App\Models\Leave::where('leave_category_id', $category->id)->where('status', 1)->where('user_id', $leave->id)->whereYear('from_date', date('Y'))->sum('day_count');

                                                            $totalRemain = ($category->day_number ?? '') - ($totalTaken ?? 0);

                                                            echo "<td class='text-center'>".($totalRemain ?? 0)."</td>";
                                                        }
                                                    @endphp
                                                </tr>
