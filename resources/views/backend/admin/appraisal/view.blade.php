...
@section('title', ''.($global_setting->title ?? "").' | Appraisal Details')
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{__('pages.Appraisal Details')}}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{route('admin.home')}}">{{__('menu.Dashboard')}}</a></li>
                            <li class="breadcrumb-item active">{{__('pages.Appraisal Details')}}</li>
                        </ol>
                    </div>
            ...
            <div class="col-xxl-12">
                ...
                <div class="card card-height-100">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">{{__('pages.Appraisal Details')}}</h4>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12">
                                    <div>
                                        ...
                                        <select class="form-control " name="user_id" id="user_id" required autocomplete="off">
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12">
                                    <div>
                                        ...
                                        <input type="number" class="form-control" name="basic_salary" id="basic_salary" value="{{$appraisal->basic_salary}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12">
                                    <div>
                                        <label for="description" class="form-label">{{__('pages.Created By')}}</label>
                                        <input type="text" class="form-control" placeholder="Created By" value="{{$appraisal->createdBy->name_en ?? ''}}">
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12">
                                    <div>
                                        <label for="description" class="form-label">{{__('pages.Last Updated By')}}</label>
                                        <input type="text" class="form-control" placeholder="Last Updated By" value="{{$appraisal->updatedBy->name_en ?? ''}}">
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="hidden_area @if($appraisal->documents == '') d-none @endif" style="max-width: 500px;">
                                                <table class="table table-bordered table-sm text-left table-area">
                                                    <thead>
                                                        <tr>
                                                        <th>{{__('pages.File Title')}}</th>
                                                        <th>{{__('pages.Documents')}}</th>
                                                    ...
                                                    @endphp
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{asset('storage/appraisal')}}/{{$document->file}}" download="download" target="_blank">
                                                                    {{__('pages.Download')}}
                                                                </a>
                                                            </td>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div style="max-width:400px" class="transfer_applied @if($appraisal->transfer_applied != 1) d-none @endif">
                                                ...
                                                <select class="form-control " name="transfer_id" id="transfer_id">
