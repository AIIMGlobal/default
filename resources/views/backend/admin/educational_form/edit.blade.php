...
@section('title', ''.($global_setting->title ?? "").' | '.__('pages.Update Educational Form'))
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{__('pages.Update Educational Form')}}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">{{__('menu.Dashboard')}}</a></li>
                            <li class="breadcrumb-item active">{{__('pages.Update Educational Form')}}</li>
                        </ol>
                    </div>
            ...
            <div class="col-xxl-12">
                ...
                <div class="card card-height-100">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">{{__('pages.Update Educational Form')}}</h4>
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.education_form.update',$educational_form->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="name_en" id="name_en" placeholder="Enter Educational Form Name" autocomplete="off" value="{{$educational_form->name_en}}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12" style="margin-top: 3%">
                                    <div class="form-check form-switch form-switch-custom form-switch-success mb-3">
                                        ...
                                        <input class="form-check-input form-control" type="checkbox" role="switch" name="roll" id="roll" value="1" @if($educational_form->roll == 1) checked @endif autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12" style="margin-top: 3%">
                                    <div class="form-check form-switch form-switch-custom form-switch-success mb-3">
                                        ...
                                        <input class="form-check-input form-control" type="checkbox" role="switch" name="reg_no" id="reg_no" value="1" @if($educational_form->reg_no == 1) checked @endif autocomplete="off">
                                    </div>
                                </div>
                                    ...
                                    <label for="institute_ids" class="form-label">{{__("pages.Select Institute (keep blank if don't want to show)")}}</label>
                                        <select class="form-control select2" name="institute_ids[]" id="institute_ids" multiple>
                                            ...
                                            @foreach ($institutes as $institute)
                                                <option @if(in_array($institute->id,explode(',',$educational_form->institute_ids))) selected @endif value="{{$institute->id}}">{{$institute->name_en}}</option>
                                            @endforeach
                                        </select>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12" style="margin-top: 3%">
                                    <div class="form-check form-switch form-switch-custom form-switch-success mb-3">
                                        ...
                                        <input class="form-check-input form-control" type="checkbox" role="switch" name="institute_name" id="institute_name" @if($educational_form->institute_name == 1) checked @endif value="1" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12" style="margin-top: 3%">
                                    <div class="form-check form-switch form-switch-custom form-switch-success mb-3">
                                        ...
                                        <input class="form-check-input form-control" type="checkbox" role="switch" name="pass_year" id="pass_year" value="1" @if($educational_form->pass_year == 1) checked @endif autocomplete="off">
                                    </div>
                                </div>
                                    ...
                                    <label for="exam_category_id" class="form-label">{{__("pages.Select Exam Category (keep blank if don't want to show)")}}</label>
                                        <select class="form-control select2" name="exam_category_id" id="exam_category_id">
                                            ...
                                            @foreach ($exam_categories as $exam_category)
                                                <option @if($educational_form->exam_category_id == $exam_category->id) selected @endif value="{{$exam_category->id}}">{{$exam_category->name_en}}</option>
                                            @endforeach
                                        </select>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12" style="margin-top: 3%">
                                    <div class="form-check form-switch form-switch-custom form-switch-success mb-3">
                                        ...
                                        <input class="form-check-input form-control" type="checkbox" role="switch" name="exam_name" id="exam_name" value="1" @if($educational_form->exam_name == 1) checked @endif autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12" style="margin-top: 3%">
                                    <div class="form-check form-switch form-switch-custom form-switch-success mb-3">
                                        ...
                                        <input class="form-check-input form-control" type="checkbox" role="switch" name="result_type" id="result_type" value="1" @if($educational_form->result_type == 1) checked @endif autocomplete="off">
                                    </div>
                                </div>
                                    ...
                                    <label for="board_ids" class="form-label">{{__("pages.Select Boards (keep blank if don't want to show)")}}</label>
                                        <select class="form-control select2" name="board_ids[]" id="board_ids" multiple>
                                            ...
                                            @foreach ($boards as $board)
                                                <option @if(in_array($board->id,explode(',',$educational_form->board_ids))) selected @endif value="{{$board->id}}">{{$board->name_en}}</option>
                                            @endforeach
                                        </select>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12" style="margin-top: 3%">
                                    <div class="form-check form-switch form-switch-custom form-switch-success mb-3">
                                        ...
                                        <input class="form-check-input form-control" type="checkbox" role="switch" name="board_name" id="board_name" value="1" @if($educational_form->board_name == 1) checked @endif autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12" style="margin-top: 3%">
                                    <div class="form-check form-switch form-switch-custom form-switch-success mb-3">
                                        ...
                                        <input class="form-check-input form-control" type="checkbox" role="switch" name="duration_id" id="duration_id" value="1" @if($educational_form->duration_id == 1) checked @endif autocomplete="off">
                                    </div>
                                </div>
                                    ...
                                    <label for="subject_category_id" class="form-label">{{__("pages.Select Subject Category (keep blank if don't want to show)")}}</label>
                                        <select class="form-control select2" name="subject_category_id" id="subject_category_id">
                                            ...
                                            @foreach ($subject_categories as $subject_category)
                                                <option @if($educational_form->subject_category_id == $subject_category->id) selected @endif value="{{$subject_category->id}}">{{$subject_category->name_en}}</option>
                                            @endforeach
                                        </select>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12" style="margin-top: 3%">
                                    <div class="form-check form-switch form-switch-custom form-switch-success mb-3">
                                        ...
                                        <input class="form-check-input form-control" type="checkbox" role="switch" name="subject_name" id="subject_name" value="1" @if($educational_form->subject_name == 1) checked @endif autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12" style="margin-top: 3%">
                                    <div class="form-check form-switch form-switch-custom form-switch-success mb-3">
                                        ...
                                        <input class="form-check-input form-control" type="checkbox" role="switch" name="certificate_file" id="certificate_file" value="1" @if($educational_form->certificate_file == 1) checked @endif autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12">
                                    <div>
                                        ...
                                        <input type="number" class="form-control" name="sl" id="sl" placeholder="SL" autocomplete="off" value="{{$educational_form->sl}}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12" style="margin-top: 3%">
                                    <div class="form-check form-switch form-switch-custom form-switch-success mb-3">
                                        ...
                                        <input class="form-check-input form-control" type="checkbox" role="switch" name="status" id="SwitchCheck11" value="1"  @if($educational_form->status == 1) checked @endif>
                                    </div>
                                </div>
