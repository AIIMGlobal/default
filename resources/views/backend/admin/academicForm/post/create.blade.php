...
@section('title', ''.($global_setting->title ?? "").' | '.__('pages.Add New Post'))
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">{{__('pages.Add New Post')}}</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">{{__('menu.Dashboard')}}</a></li>
                                <li class="breadcrumb-item active">{{__('pages.Add New Post')}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-height-100">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">{{__('pages.Add New Post')}}</h4>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4 col-sm-6 col-xsm-12">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="name_en" id="name_en" placeholder="Enter Post Title" value="{{ old('name_en') }}" required>
                                        </div>
                                    </div>

                                    <div class="col-md-4 col-sm-6 col-xsm-12">
                                        <div>
                                            <label for="post_category_id" class="form-label">{{__('pages.Post Category')}}<span style="color:red;">*</span></label>
