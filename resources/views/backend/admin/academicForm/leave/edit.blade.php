...
@section('title', ''.($global_setting->title ?? "").' | '.__('pages.Update Leave'))
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{__('pages.Update Leave')}}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">{{__('menu.Dashboard')}}</a></li>
                            <li class="breadcrumb-item active">{{__('pages.Update Leave')}}</li>
                        </ol>
                    </div>
            ...
            <div class="col-xxl-12">
                ...
                <div class="card card-height-100">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">{{__('pages.Update Leave')}}</h4>
                            ...
                            <div class="row g-3">
                                    ...
                                    <div>
                                        ...
                                        <select class="form-control select2" name="user_id" id="user_id" required>
                                            ...
                                            @foreach ($users as $user)
                                                <option value="{{$user->id}}" @if($leave->user_id == $user->id) selected @endif>{{$user->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>

                                <div class="col-md-4 col-sm-6 col-xsm-12 d-none">
                                    <div>
                                        <label for="office_id" class="form-label">{{__('pages.Select Office')}}<span style="color:red;">*</span></label>
                                        <select class="form-control select2" name="office_id" id="office_id" required>
                                            <option value="">--{{__('pages.Select Office')}}--</option>
                                            @foreach ($offices as $office)
                                                <option value="{{$office->id}}" @if($leave->office_id == $office->id) selected @endif>{{$office->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <select class="form-control select2" name="leave_category_id" id="leave_category_id" required>
                                            ...
                                            @foreach ($leaveCategories as $leaveCategory)
                                                <option value="{{$leaveCategory->id}}" @if($leave->leave_category_id == $leaveCategory->id) selected @endif>{{$leaveCategory->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="title" id="title" placeholder="Enter Leave Title" value="{{$leave->title}}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8 col-sm-12">
                                    <div>
                                        ...
                                        <textarea class="form-control" name="reason" id="reason" rows="5" required>{{$leave->reason}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12">
                                    <div>
                                        ...
                                        <input type="date" class="form-control" name="start" id="start" placeholder="Leave start date" value="{{$leave->start}}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xsm-12">
                                    <div>
                                        ...
                                        <input type="date" class="form-control" name="end" id="end" placeholder="Leave end date" value="{{$leave->end}}" required>
                                    </div>
                                </div>

                                <div class="col-md-4 col-sm-6 col-xsm-12">
                                    <div>
                                        <label for="documents" class="form-label">{{__('pages.Replace Old File')}}</label>
