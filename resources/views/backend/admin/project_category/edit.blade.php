...
@section('title', ''.($global_setting->title ?? "").' | Edit project category')
@section('content')
            ...
            <div class="col-xxl-12">
                ...
                <div class="card card-height-100">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Edit project category</h4>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div>
                                        ...
                                        <input id="name" type="text" class="form-control" name="name" value="{{$category->name}}" placeholder="Category Name" required>
                                    </div>
                                </div>
                                <div class="col-md-8">
