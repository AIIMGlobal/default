...
@section('title', ''.($global_setting->title ?? "").' | Create New E-Ticket')
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Create New E-Ticket</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>

                                <li class="breadcrumb-item active">Create New E-Ticket</li>
                            </ol>
                        </div>
            ...
            <div class="row">
                <div class="offset-md-1 col-md-10">
                    ...
                    <div class="card card-height-100">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.eTicket.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-12 mt-4">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="title" name="title" placeholder="Enter Your Issue" value="{{ old('title') }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 mt-4">
                                            <div>
                                                ...
                                                <textarea class="form-control" id="description" name="description" placeholder="Enter Description" rows="10">{{ old('description') }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-sm-12 mt-5">
                                            <div class="form-check form-switch form-switch-custom form-switch-success mb-3">
                                                <label class="form-check-label form-label" for="SwitchCheck_5">Has attachement?</label>
