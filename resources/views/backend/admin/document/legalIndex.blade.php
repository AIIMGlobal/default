...
@section('title', ''.($global_setting->title ?? "").' | Legal Document List')
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Legal Document List</h4>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-height-100">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Legal Document List</h4>

                            <div class="flex-shrink-0">
                                @can('add_legal_document')
                                    <a class="btn btn-primary" href="{{ route('admin.document.legalCreate') }}">
                            ...
                            <form>
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-2 col-sm-4">
                                        <div>
                                            <a style="max-width: 150px;" href="{{ route('admin.document.legalIndex') }}" class="btn btn-danger w-100"> 
