...
@section('title', ''.($global_setting->title ?? "").' | Membership Document List')
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Membership Document List</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>

                                <li class="breadcrumb-item active">Membership Document List</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-height-100">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Membership Document List</h4>

                            <div class="flex-shrink-0">
                                @can('add_financial_document')
                                    <a class="btn btn-primary" href="{{ route('admin.document.membershipCreate') }}">
                                        Add New Membership Document
                                    </a>
                                @endcan
                            </div>
                        </div>
                            ...
                            <form>
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-2 col-sm-4">
                                        <div>
                                            <a style="max-width: 150px;" href="{{ route('admin.document.membershipIndex') }}" class="btn btn-danger w-100"> 
