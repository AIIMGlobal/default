...
@if(Session::has('info'))
  <div class="alert alert-warning alert-dismissible fade show" role="alert">
    ...
    <strong>Alert!</strong> {{ __(Session::get('info')) }}
...
@if(Session::has('warning'))
  <div class="alert alert-warning alert-dismissible fade show" role="alert">
    <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Alert:"><use xlink:href="#info-fill"/></svg>

    <strong>Alert!</strong> {{ __(Session::get('warning')) }}
