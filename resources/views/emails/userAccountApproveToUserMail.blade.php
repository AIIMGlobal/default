                                        ...
                                        <div style="width: 100% !important;">
                                            ...
                                            <!--<![endif]-->
                                                <table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 5px;font-family:'Lato',sans-serif;" align="left">
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;" align="left">
                                                                <div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <span style="font-size: 18px; line-height: 25.2px; color: #666666;">Hello {{ $user->name_en ?? '' }}, </span>
                                                                    </p>
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        @if ($user->status == 1)
                                                                            <span style="font-size: 14px; line-height: 25.2px; color: #000;">Congratulations! Your account has been approved.</span>

                                                                            @if ($user->google_id)
                                                                                <br>

                                                                                <span style="font-size: 14px; line-height: 25.2px; color: #000;">Your login password is: 12345678.</span>
                                                                            @endif
                                                                        @else
                                                                            <span style="font-size: 14px; line-height: 25.2px; color: #000;">Your account request is declined.</span>
                                                                        @endif
                                                                    </p>
                                                                </div>
                                                            </td>
