                                                                ...
                                                                <div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    @if ($leave->status == 1)
                                                                        <p style="font-size: 14px; line-height: 140%;">
                                                                            <span style="font-size: 18px; line-height: 25.2px; color: #666666;">Hello {{ $leaveUser->name_en ?? '' }}, </span>
                                                                        </p>
                                                                        ...
                                                                        <p style="font-size: 14px; line-height: 140%;">
                                                                            <span style="font-size: 14px; line-height: 25.2px; color: #000;">Your application for {{ $leave->day_count > 1 ? $leave->day_count . ' days' : $leave->day_count . ' day' }} of {{ $leave->category->name_en ?? '' }} Leave from {{ date('d M, Y', strtotime($leave->from_date)) }} to {{ date('d M, Y', strtotime($leave->to_date)) }} has been approved.
                                                                        
                                                                                <br>

                                                                                @if ($leave->hod_comment)
                                                                                    HOD Comment: "{{ $leave->hod_comment }}"
                                                                                @endif
                                                                            </span>
                                                                        </p>
                                                                    @elseif ($leave->status == 3)
                                                                        ...
                                                                        <p style="font-size: 14px; line-height: 140%;">
                                                                            <span style="font-size: 14px; line-height: 25.2px; color: #000;">I recommend you to approve leave application of {{ $leave->employee->name_en ?? '' }} (EID: {{ $leave->employee->userInfo->employee_id ?? '' }}) for {{ $leave->day_count > 1 ? $leave->day_count . ' days' : $leave->day_count . ' day' }} of {{ $leave->category->name_en ?? '' }} Leave from {{ date('d M, Y', strtotime($leave->from_date)) }} to {{ date('d M, Y', strtotime($leave->to_date)) }}.
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        <p style="font-size: 14px; line-height: 140%;">
                                                                            <span style="font-size: 14px; line-height: 25.2px; color: #000;">Your application for {{ $leave->day_count > 1 ? $leave->day_count . ' days' : $leave->day_count . ' day' }} of {{ $leave->category->name_en ?? '' }} Leave from {{ date('d M, Y', strtotime($leave->from_date)) }} to {{ date('d M, Y', strtotime($leave->to_date)) }} has been declined.
