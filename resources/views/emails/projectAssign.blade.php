...
xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    <head>
        ...
        <!--<![endif]-->
        <title>Project Employee Assign</title>
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                                                                ...
                                                                <div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <span style="font-size: 18px; line-height: 25.2px; color: #666666;">Hello {{ $employee->name_en ?? '' }}, </span>
                                                                    </p>
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <span style="font-size: 14px; line-height: 25.2px; color: #000;">You have been assigned to <b>{{ $project->name }}</b> project.</span>
                                                                    </p>
                                                                </div>
