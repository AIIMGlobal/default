                                                        ...
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                                                                ...
                                                                <div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <span style="font-size: 14px; line-height: 25.2px; color: #000;">{{ $leave->employee->name_en ?? '' }} (EID: {{ $leave->employee->userInfo->employee_id ?? '' }}) has requested for {{ $leave->day_count > 1 ? $leave->day_count . ' days' : $leave->day_count . ' day' }} of {{ $leave->category->name_en ?? '' }} Leave from {{ date('d M, Y', strtotime($leave->from_date)) }} to {{ date('d M, Y', strtotime($leave->to_date)) }}.</span>
                                                                    </p>
                                                                </div>
