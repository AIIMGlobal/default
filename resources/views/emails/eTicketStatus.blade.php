...
xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    <head>
        ...
        <!--<![endif]-->
        <title>E-Ticket Status Change</title>
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                                                                ...
                                                                <div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <span style="font-size: 18px; line-height: 25.2px; color: #666666;">Hello {{ $eTicket->client->name_en ?? '' }}, </span>
                                                                    </p>
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        @if ($eTicket->status == 1)
                                                                            <span style="font-size: 14px; line-height: 25.2px; color: #000;">Your E-Ticket #{{ $eTicket->ticket_no }} has been accepted.</span>
                                                                        @elseif ($eTicket->status == 2)
                                                                            <span style="font-size: 14px; line-height: 25.2px; color: #000;">Your E-Ticket #{{ $eTicket->ticket_no }} status has been changed to solved.</span>

                                                                            @if ($eTicket->remarks)
                                                                                <br>

                                                                                <span style="font-size: 14px; line-height: 25.2px; color: #000;">**Remarks: {{ $eTicket->remarks }}</span>
                                                                            @endif
                                                                        @elseif ($eTicket->status == 3)
                                                                            <span style="font-size: 14px; line-height: 25.2px; color: #000;">Your E-Ticket #{{ $eTicket->ticket_no }} has been declined.</span>
